<?php
    ...
    $prod_watch = 'Smartwatches';
    $q = "SELECT * FROM prod_cat where category = '$prod_watch' LIMIT $start, $per_page";
    $query = $pdo->prepare($q);
    $query->execute();
    ...
    $count_query = "SELECT * FROM prod_cat where category = '$prod_watch'";
...
<section class="light">
    <div class="container py-4">
        <h1 class="headprod">Smart Watches</h1>
